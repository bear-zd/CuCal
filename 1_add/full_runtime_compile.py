...
low = 0
high = 10
int_a = torch.randint(low, high, (n,n), device="cuda:0")
int_b = torch.randint(low, high, (n,n), device="cuda:0")
int_cuda_c = torch.randint(low, high, (n,n), device="cuda:0")
ntest = 10
...
if __name__ == "__main__":
    ...
    print(f"Sum of cuda core: {cuda_res.sum()}; Sum of torch: {torch_res.sum()}")
