...
cuda_src = Path("layernorm_kernel.cu").read_text()
cpp_src = "torch::Tensor launch_layernorm_kernel_fp32(torch::Tensor x, torch::Tensor w, torch::Tensor b);"
funcs = ["launch_layernorm_kernel_fp32"]
...
lib.launch_layernorm_kernel_fp32 = show_time(lib.launch_layernorm_kernel_fp32)
torch_res = torch_ln(i1)
cuda_res = lib.launch_layernorm_kernel_fp32(i1, w, b)
